...
namespace SIR_Zaverecna_Prace.Controllers
{
    public class DevelopersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,FoundedAt,Residence")] Developer developer)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,FoundedAt,Residence")] Developer developer)
        {
            if (id != developer.Id)
            {
                return NotFound();
